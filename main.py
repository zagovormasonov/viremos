...
async def generate_meditation(card: CardInput):
    try:
        ...
        prompt = f"""
            Сгенерируй короткую медитацию (до 200 слов) с легкой музыкой на заднем фоне, на русском языке в женском спокойном стиле с медленной, успокаивающей речью, длительностью до 3 минут. 
